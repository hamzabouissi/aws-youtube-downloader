...
class YoutubeSpider(scrapy.Spider):
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(YoutubeSpider, cls).from_crawler(crawler, *args, **kwargs)
        return spider
    ...
    def parse(self, response):
        ...
        for suggest in suggestions:
            if compact_video := suggest.get("compactVideoRenderer",None):
                ...
                # yield  JsonRequest(url=self.start_urls[0],callback=self._get_next_suggest_videos, data=payload) 
